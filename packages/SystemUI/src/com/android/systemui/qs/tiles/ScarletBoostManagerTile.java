...
public class ScarletBoostManagerTile extends SecureQSTile<QSTile.BooleanState> {
    ...
    @Inject
    public ScarletBoostManagerTile(
            QSHost host,
        ...
        mSetting = new SettingObserver(systemSettings, mHandler, Settings.System.SCARLET_SYSTEM_BOOST) {
            @Override
    ...
    private void setEnabled(boolean enabled) {
        Settings.System.putInt(mContext.getContentResolver(),
                Settings.System.SCARLET_SYSTEM_BOOST, enabled ? 1 : 0);
	ScarletSystemManager.startBoostingService(enabled);
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        final boolean sysBoostManagerEnabled = Settings.System.getIntForUser(mContext.getContentResolver(),
                Settings.System.SCARLET_SYSTEM_BOOST, 0, UserHandle.USER_CURRENT) == 1;

        state.value = sysManagerState;
        state.label = mContext.getString(R.string.quick_settings_scarlet_boost_mode_label);
        state.icon = mIcon;
        state.contentDescription = TextUtils.isEmpty(state.secondaryLabel)
                ? state.label
                : TextUtils.concat(state.label, ", ", state.secondaryLabel);
	state.secondaryLabel = sysManagerEnabled ? mContext.getResources().getString(sysBoostManagerEnabled ? R.string.quick_settings_scarlet_boost_mode_enabled : R.string.quick_settings_scarlet_boost_mode_disabled) : mContext.getResources().getString(R.string.quick_settings_scarlet_services_unavailable);
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.SCARLET_SYSTEM_BOOST), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(

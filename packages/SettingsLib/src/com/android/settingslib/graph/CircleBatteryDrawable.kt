...
class CircleBatteryDrawable(private val context: Context, frameColor: Int) : Drawable() {
    ...
    private var BATTERY_STYLE_BIG_CIRCLE = 17
    private var BATTERY_STYLE_BIG_DOTTED_CIRCLE = 18
    ...
    override fun draw(c: Canvas) {
        ...
        if (meterStyle == BATTERY_STYLE_DOTTED_CIRCLE || meterStyle == BATTERY_STYLE_BIG_DOTTED_CIRCLE) {
